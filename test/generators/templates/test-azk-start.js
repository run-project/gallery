...
var tempFn = doT.template([
  ...
  // FIXME: ERROR: read: read error: 0: Resource temporarily unavailable
  // '',
  // 'echo ""',
  // 'echo ""',
  // 'echo " +++++++++++++++++++++++++++"',
  // 'echo "   Go check:"',
  // 'echo "     http://{{=it.name}}.dev.azk.io/"',
  // 'echo " +++++++++++++++++++++++++++"',
  // 'echo ""',
  // 'TTY=$(/usr/bin/tty)',
  // 'exec 3<&0 < $TTY',
  // 'echo -n " [ press Ctrl + C to abort or any key to continue ] "',
  // 'read -r var 0<&3',

  'echo ""',
  'echo ""',
  'echo " +++++++++++++++++++++++++++"',
  'echo "  AFTER TEST CLEANNING {{=it.repoOwner}}/{{=it.name}}#{{=it.branch}}"',
  'echo " +++++++++++++++++++++++++++"',
  '',
  'echo ""',
  'echo "cd /tmp/buttons/{{=it.name}} folder"',
