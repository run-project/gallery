module.exports = {
  projects: [
    ...
    { name:     'task-cerebral',   repoOwner: 'saitodisse', branch: 'master'  },
    ...
    // { name:     'selfstarter',     repoOwner: 'azukiapp',   branch: 'master'  },
    // { name:     'jekyll',          repoOwner: 'fearenales', branch: 'master'  },
    // { name:     'feedbin',         repoOwner: 'azukiapp',   branch: 'azkfile' },
    // { name:     'diaspora',        repoOwner: 'fearenales', branch: 'azkfile' },
  ]
}
